...
echo "🚀 Firebase Function - Text Plan Generator"
echo "=========================================="
...
echo "🎯 Usage Examples:"
echo "=================="
echo "./generate_text_plan.sh \"CouchBase Store\" ecommerce medium \"React, Node.js, CouchBase\""
echo "./generate_text_plan.sh \"Mobile App\" mobile high \"React Native, Firebase\""
echo "./generate_text_plan.sh \"ML Pipeline\" ml enterprise \"Python, TensorFlow\""
